...
```text
/home/operator/install-media/2faskw-idp-plugin-0.1.0-SNAPSHOT.zip
...
```bash
sha256sum /home/operator/install-media/2faskw-idp-plugin-0.1.0-SNAPSHOT.zip
...
scp graphicalmatrix-plugin-local-dist/2faskw-idp-plugin-1.0.1.zip \
  operator@192.0.2.60:/tmp/2faskw-idp-plugin-1.0.1.zip
```

サーバ上の配置:

```text
/home/operator/install-media/2faskw-idp-plugin-1.0.1.zip
...
sudo unzip -q /home/operator/install-media/2faskw-idp-plugin-1.0.1.zip -d /opt/src
