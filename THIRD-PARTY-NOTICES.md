...
| Component | Version | License | Notes |
| --- | --- | --- | --- |
| Jackson annotations | 2.21.2 | Apache-2.0 | JSON annotations. |
| Jackson core | 2.21.2 | Apache-2.0 | JSON streaming support. |
| Jackson databind | 2.21.2 | Apache-2.0 | JSON serialization and deserialization. |
| Jackson datatype JSR310 | 2.21.2 | Apache-2.0 | Java date/time JSON support. |
